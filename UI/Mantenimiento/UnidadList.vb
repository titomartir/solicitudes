...
#Region "difinition"
    ...
    Private TITLE As String = "Lista de unidad"
...
#Region "Text Event"
    ...
    Private Sub txtBNumero_TextChanged(sender As Object, e As EventArgs) Handles txtBCodigoUnid.TextChanged
...
#Region "DataGridView Event"
    ...
    Private Sub dgvList_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvList.CellContentClick
        ...
        'Get Key
        Dim wkCodigoUnid As String = Me.dgvList.Item(dgvCol.Numero, e.RowIndex).Value.ToString

        Select Case e.ColumnIndex
            Case dgvCol.btnEdit 'Edit

                Using Frm As New EditUnidad
                    Frm.CodigoUnid = wkCodigoUnid
                    Frm.EditMode = True
                    Frm.ShowDialog()
                End Using
...
#Region "User Method"
    ...
    Private Sub DispList()
        ...
        'Set Condition
        Dim dtcondition As DataTable = Entity.GetTable(Entity.TableNmae.Unidad)
        Dim dr As DataRow = dtcondition.NewRow
        dr.Item(Entity.Unidad.Codigo_Unid) = Me.txtBCodigoUnid.Text
        dr.Item(Entity.Unidad.Nombre_Unid) = Me.txtBNombre.Text
        dtcondition.Rows.Add(dr)

        'Table Access
        If bc.Unidad_select_list(dtRet, dtcondition) <> HospitalConst.DB_RET.NML Then
    ...
    ''' Delete Unidad Data
    ''' </summary>
    Private Sub DeleteUnidad(ByVal wkCodigoUnid As String)
        ...
        Dim dtcondition As DataTable = Entity.GetTable(Entity.TableNmae.Unidad)
        Dim dr As DataRow = dtcondition.NewRow
        dr.Item(Entity.Unidad.Codigo_Unid) = wkCodigoUnid
        dtcondition.Rows.Add(dr)

        'Table Access
        If bc.Unidad_delete(dtcondition) < HospitalConst.DB_RET.NML Then
            MessageBoxManager.ShowError("Error en la base de datos")
            Exit Sub
        End If
