...
#Region "Property"
    Private _CodigoUnid As String = ""

    Public WriteOnly Property CodigoUnid As String
        Set(value As String)
            _CodigoUnid = value
        End Set
    End Property
...
#Region "Form Event"
    ...
    Private Sub Form_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If _EditMode Then
            TITLE = "Modificación del unidad"
        Else
            TITLE = "Agregar de unidad"
        End If
...
#Region "User Method"
    ...
    Private Sub DispData()
        ...
        dr.Item(Entity.Unidad.Codigo_Unid) = _CodigoUnid
        dtcondition.Rows.Add(dr)

        'Table Access
        If bc.Unidad_select_key(dtRet, dtcondition) <> HospitalConst.DB_RET.NML Then
        ...
        With dtRet.Rows(0)
            Me.txtNombre.Text = .Item(Entity.Unidad.Nombre_Unid).ToString
        End With
    ...
    Private Function InputCheck() As Boolean
        ...
        If _EditMode = False Then
            ...
            Dim dtcondition As DataTable = Entity.GetTable(Entity.TableNmae.Unidad)
            Dim dr As DataRow = dtcondition.NewRow
            dr.Item(Entity.Unidad.Codigo_Unid) = Me.txtCodigo.Text
            dtcondition.Rows.Add(dr)
    ...
    Private Sub SaveData()
        ...
        Dim dtData As DataTable = Entity.GetTable(Entity.TableNmae.Unidad)
        Dim dr As DataRow = dtData.NewRow
        dr.Item(Entity.Unidad.Codigo_Unid) = Me.txtCodigo.Text
        dr.Item(Entity.Unidad.Nombre_Unid) = Me.txtNombre.Text
        dtData.Rows.Add(dr)
        ...
        If _EditMode Then
            'Mode : Edit Data
            If bc.Unidad_update(dtData) <= 0 Then
                MessageBoxManager.ShowError("Error en la base de datos")
                Exit Sub
            End If
        ...
        Else
            'Mode : Add Data
            If bc.Unidad_insert(dtData) <= 0 Then
                MessageBoxManager.ShowError("Error en la base de datos")
                Exit Sub
            End If
